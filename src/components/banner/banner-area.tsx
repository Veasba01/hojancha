                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="tp-banner-thumb tp-banner-box p-relative mb-25  wow fadeInUp" data-wow-delay=".4s" data-wow-duration="1s">
                            ...
                            </div>                            <div className="tp-banner-content">
                                <h5 className="tp-banner-title-pre">Hora de Vivir</h5>
                                <h2 className="tp-banner-title mb-25">Aventuras Naturales</h2>
                                <h4 className="tp-banner-offer mb-45">Disfruta de más de <span className="p-relative">15+
